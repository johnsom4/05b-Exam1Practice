...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 1.4708567  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([60, 100], expected, test_results,
                                  format_string)
    actual = problem1a(60, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    print_summary_of_test_results(test_results)

    # Test 4:
    expected = -1.9687  # This is APPROXIMATELY the correct answer.
